...
public class SearchRepositoryImpl implements SearchRepository {
    ...
    public List<Post> findByText(String text) {
        final List<Post> post= new ArrayList<Post>();
        MongoDatabase mongoDatabase= mongoClient.getDatabase("mylearnings");
        MongoCollection<Document> mongoCollection=mongoDatabase.getCollection("JobPost");
